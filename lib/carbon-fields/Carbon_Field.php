...
if ( !class_exists('Carbon_Field_Button') ) :

class Carbon_Field_Button extends Carbon_Field {
	...
	function render() {
		echo '<p style="padding: 4px 0; margin: 0;"><a href="'. add_query_arg( 'publish-property', $this->cpt ) .'" class="button '. $this->button_class .' button-large">'. $this->label .'</a></p>';
	}
}
